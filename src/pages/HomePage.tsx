      ...
      <section className="mb-12">
        <div className="text-center max-w-3xl mx-auto mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Applcloud de listes de courses multiplateforme. Find detailed information, tutorials, and best practices.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between gap-8">
          <div className="md:w-1/2">
            ...
            <p className="text-muted-foreground mb-4">
              Shoppis Wiki is a community-driven resource dedicated to documenting all aspects of the Shopplistapp cross-platform. Our goal is to provide comprehensive, up-to-date information for all users.
            </p>
